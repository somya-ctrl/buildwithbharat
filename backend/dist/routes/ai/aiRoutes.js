...
const callAIModel = async (systemInstruction, promptContent) => {
...
const simulateAIResponse = (systemInstruction, content) => {
...
router.post('/explain', authMiddleware_1.protect, async (req, res) => {
    const { code } = req.body;
    if (!code) {
...
router.post('/debug', authMiddleware_1.protect, async (req, res) => {
...
router.post('/generate', authMiddleware_1.protect, async (req, res) => {
